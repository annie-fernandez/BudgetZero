...
const RegisterUser = (): JSX.Element => {
  ...
  return (
    <div className={classes.content}>
      <Stepper active={current} breakpoint="sm" onStepClick={(): null => null}>
        <Stepper.Step description="Your Info" label="First step">
          <Step1 active={current} nextStep={nextStep} prevStep={prevStep} />
        </Stepper.Step>
        <Stepper.Step description="Profile Image" label="Second step">
          <Step2 active={current} nextStep={nextStep} prevStep={prevStep} />
        </Stepper.Step>
        <Stepper.Completed>
