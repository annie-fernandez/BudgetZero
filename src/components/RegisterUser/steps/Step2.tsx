...
import UploadProfileImage from "../helpers/UploadProfileImage/UploadProfileImage";
...
const Step2 = ({ prevStep }: IStepProps): JSX.Element => {
  ...
  return (
    <div>
      ...
      <UploadProfileImage image={profileImage} setImage={setProfileImage} />
      <Flex align="center" m={20} mt={30}>
        <Avatar
          mr={20}
          radius="50%"
          size={120}
